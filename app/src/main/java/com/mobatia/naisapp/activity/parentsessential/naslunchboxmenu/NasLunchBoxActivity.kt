package com.mobatia.naisapp.activity.parentsessential.naslunchboxmenu
...
class NasLunchBoxActivity : AppCompatActivity() {
    ...
    private fun callTermDatesDetailAPI() {
        ...
        val call: Call<LunchBoxResponse> = ApiClient.getClient.lunchbox( 1)
