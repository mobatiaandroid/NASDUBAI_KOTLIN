...
class NaeProgrammesDetail : AppCompatActivity() {
    ...
    var naedetailslist = ArrayList<DetailListitems>()
        ...
        naeRecyclerdetails.addOnItemClickListener(object : OnItemClickListener {
            override fun onItemClicked(position: Int, view: View) {
                ...
                if (urltype.contains("pdf")) {
                    ...
                    intent.putExtra("webview_url", naedetailslist[position].url)
                    this@NaeProgrammesDetail.startActivity(intent)
                }
    ...
    private fun primarydetailslist() {
        ...
        val call: Call<CommonDetailResponse> = ApiClient.getClient.nae_programmesdetails(id.toInt(), 1)
        call.enqueue(object : Callback<CommonDetailResponse> {
            ...
            override fun onResponse(
                ...
                if (response.body()!!.status == 100) {
                    naedetailslist.addAll(response.body()!!.data.detaillists)
