...
class Early_yearsComingUp : AppCompatActivity() {
    ...
    var early_yearscominguplist = ArrayList<ComingUpListitems>()
    ...
    private fun InitUI() {
        ...
        comingsoonrecycler.addOnItemClickListener(object : OnItemClickListener {
            override fun onItemClicked(position: Int, view: View) {
                ...
                if (early_yearscominguplist[position].url.isNotEmpty()) {
                    webViewComingUpDetail =
                        "$webViewComingUpDetail<center><img src='" + early_yearscominguplist[position].url + "'width='100%', height='auto'>"
    ...
    private fun cominguplist() {
        ...
        val call: Call<Comingupresponse> = ApiClient.getClient.early_yearscomingup(1)
        call.enqueue(object : Callback<Comingupresponse> {
            ...
            override fun onResponse(
                ...
                if (response.body()!!.status == 100) {
                    early_yearscominguplist.addAll(response.body()!!.data.cominguplists)
